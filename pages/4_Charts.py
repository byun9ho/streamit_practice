...
col1.metric(label='온도',value='22℃', delta='1.2℃',
            delta_color='inverse')
col2.metric(label='풍속',value='9㎧', delta='-8%',
            delta_color='inverse')

st.divider()
st.subheader("delta_color='normal'<- default")
col1,col2=st.columns(2)
col1.metric(label='온도',value='22℃', delta='1.2℃',
            delta_color='normal')
col2.metric(label='풍속',value='9㎧', delta='-8%',
...
st.area_chart(df,y=['A','B','C'], color=['#ff0033','#009933','#0055ff'])
