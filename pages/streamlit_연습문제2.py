...
with open('c://workspace_Multi07/09_streamlit/webDash/data/경기도행정구역경계.json', encoding='utf-8') as f:
    geo_gg=json.loads(f.read())
df_gg=pd.read_excel('c://workspace_Multi07/09_streamlit/webDash/data/경기도인구데이터.xlsx', index_col='구분')
st.dataframe(df_gg)
